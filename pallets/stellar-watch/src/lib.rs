...
impl<T: SigningTypes> SignedPayload<T> for Payload<T::AccountId, T::Public, T::Balance> where T: BalancesConfig {
...
pub trait Config: frame_system::Config + CreateSignedTransaction<Call<Self>> + BalancesConfig + PaymentConfig {
...
impl<T: Config> Module<T> {
	...
	fn offchain_unsigned_tx_signed_payload(deposit: T::Balance, destination: T::AccountId) -> Result<(), Error<T>> {
